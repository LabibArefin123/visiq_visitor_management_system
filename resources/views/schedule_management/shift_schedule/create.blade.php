...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('shift_schedules.index') }}" class="btn btn-sm btn-secondary d-flex align-items-center gap-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="shift_type" id="shift_type"
                                ...
                                <option value="Morning" {{ old('shift_type') == 'Morning' ? 'selected' : '' }}>Morning
                                </option>
                                <option value="Evening" {{ old('shift_type') == 'Evening' ? 'selected' : '' }}>Evening
                                </option>
