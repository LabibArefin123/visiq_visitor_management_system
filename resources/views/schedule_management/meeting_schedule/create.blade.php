...
@section('title', 'Add Meeting Schedule')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Create Meeting Schedule</h3>
...
@section('content')
    <div class="container">
        <div class="card shadow-lg">
            <div class="card-body">
                <form action="{{ route('meeting_schedules.store') }}" method="POST" data-confirm="create">
                    @csrf
                    <div class="row">
                        {{-- Schedule Name --}}
                        ...
                        <div class="col-md-6 form-group">
                            <label for="meeting_date"><strong>Meeting Date</strong> <span
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="meeting_type" id="meeting_type"
                                ...
                                <option value="">Select Meeting Type
                                <option value="Single" {{ old('meeting_type') == 'Single' ? 'selected' : '' }}>Single
                                </option>
                                <option value="Group" {{ old('meeting_type') == 'Group' ? 'selected' : '' }}>Group
                                </option>
                            </select>
                            @error('meeting_type')
                                <small class="text-danger">{{ $message }}</small>
