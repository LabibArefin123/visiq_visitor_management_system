...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Edit Area</h3>
        <a href="{{ route('areas.index') }}" class="btn btn-sm btn-secondary d-flex align-items-center gap-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="name_in_bangla" id="name_in_bangla"
                                ...
                                value="{{ old('name_in_bangla', $area->name_in_bangla) }}">
