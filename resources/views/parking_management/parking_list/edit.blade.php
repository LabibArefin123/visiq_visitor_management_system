...
@section('content')
    <div class="container">
        <div class="card shadow-lg">
            <div class="card-body">
                <form action="{{ route('parking_lists.update', $parkingList->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="parking_name" id="parking_name"
                                ...
                                value="{{ old('parking_name', $parkingList->parking_name) }}">
                            @error('parking_name')
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="level" id="level"
                                ...
                                value="{{ old('level', $parkingList->level) }}">
                            @error('level')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="status" id="status" class="form-control">
                                <option value="Available"
                                    {{ old('status', $parkingList->status) == 'Available' ? 'selected' : '' }}>Available
                                </option>
                                <option value="Occupied"
                                    {{ old('status', $parkingList->status) == 'Occupied' ? 'selected' : '' }}>Occupied
                                </option>
                                <option value="Reserved"
                                    {{ old('status', $parkingList->status) == 'Reserved' ? 'selected' : '' }}>Reserved
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="alloted_by" id="alloted_by"
                                ...
                                value="{{ old('alloted_by', $parkingList->alloted_by) }}">
                            @error('alloted_by')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
