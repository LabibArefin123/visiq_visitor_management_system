...
@section('title', 'Edit Visitor Probation')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Edit Visitor on Probation</h3>
...
@section('content')
    <div class="container">
        <div class="card shadow-lg">
            <div class="card-body">
                <form action="{{ route('visitor_probations.update', $visitorProbation->id) }}" method="POST"
                    data-confirm="edit">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="probation_id" id="probation_id"
                                ...
                                value="{{ old('probation_id', $visitorProbation->probation_id) }}"
                                placeholder="Enter Probation ID">
                            @error('probation_id')
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                value="{{ old('name', $visitorProbation->name) }}" placeholder="Enter visitor name">
                            @error('name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="phone" id="phone"
                                ...
                                value="{{ old('phone', $visitorProbation->phone) }}" placeholder="Enter phone number">
                            @error('phone')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="national_id" id="national_id"
                                ...
                                value="{{ old('national_id', $visitorProbation->national_id) }}"
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <textarea name="reason" id="reason" rows="3" class="form-control @error('reason') is-invalid @enderror"
                                placeholder="Enter reason for probation">{{ old('reason', $visitorProbation->reason) }}</textarea>
                            @error('reason')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="pending"
                                    {{ old('status', $visitorProbation->status) == 'pending' ? 'selected' : '' }}>Pending
                                </option>
                                <option value="approved"
                                    {{ old('status', $visitorProbation->status) == 'approved' ? 'selected' : '' }}>Approved
                                </option>
                                <option value="cancelled"
                                    {{ old('status', $visitorProbation->status) == 'cancelled' ? 'selected' : '' }}>
                                    Cancelled
                                </option>
                            </select>
                            @error('status')
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="date" name="probation_start" id="probation_start"
                                ...
                                value="{{ old('probation_start', $visitorProbation->probation_start?->format('Y-m-d')) }}">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="date" name="probation_end" id="probation_end"
                                ...
                                value="{{ old('probation_end', $visitorProbation->probation_end?->format('Y-m-d')) }}">
                            @error('probation_end')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
