...
@section('title', 'Add Visitor Group Member')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Add Visitor Group Member</h3>
...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="number" name="total_group_members" class="form-control"
                            value="{{ old('total_group_members') }}" readonly>
                    </div>
    ...
    <script>
        // Update total group members when visitors are checked/unchecked
