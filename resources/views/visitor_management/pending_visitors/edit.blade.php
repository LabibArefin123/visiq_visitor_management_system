...
@section('title', 'Edit Pending Visitor')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Edit Pending Visitor</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="visitor_id" id="visitor_id"
                                ...
                                value="{{ old('visitor_id', $visitor->visitor_id) }}">
                            @error('visitor_id')
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="date" name="visit_date" id="visit_date"
                                ...
                                value="{{ old('visit_date', $visitor->visit_date) }}">
                            @error('visit_date')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="date" name="date_of_birth" id="date_of_birth"
                                ...
                                value="{{ old('date_of_birth', $visitor->date_of_birth) }}">
                            @error('date_of_birth')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
