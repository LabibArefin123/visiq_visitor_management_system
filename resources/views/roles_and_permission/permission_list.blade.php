...
@section('content_header')
    <h1 class="mb-4">Permission List</h1>
@endsection
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('permission.create') }}" class="btn btn-success btn-sm" id="addPermissionBtn">
...
@section('js')
    ...
    <script>
        ...
        document.getElementById('addPermissionBtn').addEventListener('click', function(event) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Do you want to add a new permission?",
                icon: 'question',
