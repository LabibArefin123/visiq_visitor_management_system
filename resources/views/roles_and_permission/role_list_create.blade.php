            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <select class="form-control" name="user_type" required>
                        ...
                        <option value="2">DD Admin</option>
                        <option value="3">AD Admin</option>
                        <option value="4">D Admin</option>
                    </select>
                </div>
                    ...
                    @foreach ($groupedRoutes as $section => $routes)
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <input type="checkbox" class="form-check-input select-all" data-section="{{ Str::slug($section) }}"
                                ...
                                @foreach ($routes as $route)
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input route-checkbox {{ Str::slug($section) }}" type="checkbox"
                                                name="routes[]" value="{{ $route->getName() }}"
        ...
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelectorAll('.select-all').forEach(function (selectAllCheckbox) {
                selectAllCheckbox.addEventListener('change', function () {
                    ...
                    const checkboxes = document.querySelectorAll('.route-checkbox.' + section);
