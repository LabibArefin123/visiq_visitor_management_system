...
@section('title', 'Edit Damaged Item')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Edit Damaged Item</h3>
...
@section('content')
    <div class="container">
        <div class="card shadow-lg">
            <div class="card-body">
                <form action="{{ route('item_damages.update', $itemDamage->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="item_name"
                                ...
                                value="{{ old('item_name', $itemDamage->item_name) }}">
                            @error('item_name')
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="item_name_in_bangla"
                                ...
                                value="{{ old('item_name_in_bangla', $itemDamage->item_name_in_bangla) }}">
                        ...
                        <div class="col-md-4 form-group mt-3">
                            ...
                            <input type="number" name="quantity"
                                ...
                                value="{{ old('quantity', $itemDamage->quantity) }}" min="1">
                            @error('quantity')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 form-group mt-3">
                            ...
                            <input type="text" name="reported_by"
                                ...
                                value="{{ old('reported_by', $itemDamage->reported_by) }}">
                            @error('reported_by')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 form-group mt-3">
                            ...
                            <input type="date" name="damage_date"
                                ...
                                value="{{ old('damage_date', $itemDamage->damage_date ? \Carbon\Carbon::parse($itemDamage->damage_date)->format('Y-m-d') : '') }}">
                            @error('damage_date')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 form-group mt-3">
                            ...
                            <textarea name="remarks" class="form-control">{{ old('remarks', $itemDamage->remarks) }}</textarea>
                        </div>
                    </div>
