...
@section('title', 'Add Medical Emergency')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Add New Medical Emergency</h3>
    ...
    <div class="container">
        <div class="card shadow-lg">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('medical_emergencies.store') }}" method="POST" data-confirm="create">
                    @csrf
                    <div class="row">
                        {{-- Incident Type --}}
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="incident_type" id="incident_type"
                                ...
                                value="{{ old('incident_type') }}" placeholder="Enter incident type">
                            @error('incident_type')
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="reported_by_type" id="reported_by_type"
                                ...
                                <option value="employee" {{ old('reported_by_type') == 'employee' ? 'selected' : '' }}>
                                    Employee</option>
                                <option value="visitor" {{ old('reported_by_type') == 'visitor' ? 'selected' : '' }}>Visitor
                                </option>
                                <option value="guard" {{ old('reported_by_type') == 'guard' ? 'selected' : '' }}>Guard
                                </option>
                            </select>
