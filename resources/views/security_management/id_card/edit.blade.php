                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="holder_type" id="holder_type"
                                ...
                                <option value="visitor"
                                    {{ old('holder_type', $idCard->holder_type) == 'visitor' ? 'selected' : '' }}>Visitor
                                </option>
                                <option value="guard"
                        ...
                        <div class="col-md-6 form-group mt-3">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="inactive"
                                    {{ old('status', $idCard->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                <option value="expired"
                                    {{ old('status', $idCard->status) == 'expired' ? 'selected' : '' }}>Expired</option>
                            </select>
                        </div>
