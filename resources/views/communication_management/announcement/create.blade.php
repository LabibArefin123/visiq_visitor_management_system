{{-- resources/views/communication_management/announcement/create.blade.php --}}
...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Add Announcement</h3>
    ...
    <div class="container">
        <div class="card shadow-lg mt-3">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('announcements.store') }}" method="POST" data-confirm="create">
                    @csrf
                    <div class="row">
                        {{-- Title --}}
